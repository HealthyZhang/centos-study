...
- pgrep 命令
	...
	- -U： 指定特定用户
	- -t： 指定终端
	- ...: 自查 [https://blog.csdn.net/Dontla/article/details/131407327]
	- demo: 
...
- 调度启动
	...
	- crontab命令，
		- 周期性计划任务
		- 所需服务：crond,由crontab命令来管理；位置=》未知~
		- 主要配置文件
			- /etc/crontab
	...
	> 如果只删除一条，重新编辑文件，在/var/spool/cron/root文件中删除即可。 
